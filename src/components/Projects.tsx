...
const Projects = () => {
  return (
    <div className="w-full max-w-7xl py-20" id="projects">
              ...
              <div className="mb-3 mt-7 flex items-center justify-between">
                <div className="flex items-center">
                  {iconLists.map((icon, idx) => (
                    <div
                      key={idx}
                      className="flex h-8 w-8 items-center justify-center rounded-full border border-white/[.2]
                ...
                <div className="flex items-center justify-center gap-2">
                  <p className="text-sm text-purple md:text-xs lg:text-xl">
                    Check Live Site
                  </p>
