...
const Hero = () => {
  return (
    <div className="w-full max-w-7xl pb-20 pt-36">
      <div>
        <Spotlight
      ...
      <div
        className="absolute left-0 top-0 flex h-screen w-full items-center justify-center bg-white
          bg-grid-black/[0.2] dark:bg-black-100 dark:bg-grid-white/[0.1]"
      >
        <div
      ...
      <div className="relative z-10 my-20 flex justify-center">
        ...
        >
          ...
          <p className="mb-4 text-center text-sm md:text-lg md:tracking-wider lg:text-2xl">
            Hi! I&apos;m Reed, a React Developer based in Philippines.
          </p>
